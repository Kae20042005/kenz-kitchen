...
Jawaban nomor 1:
Dari prioritas paling tinggi ke rendah: inline style -> ID selectors -> Class, pseudo-class, atribut selectors -> Eelement selector dan pseudo-element.

Jawaban nomor 2:
Responsive design menjadi konsep yang sangat penting dalam pengembangan aplikasi web karena cara orang mengakses internet dan menggunakan aplikasi telah berubah secara signifikan. Saat ini, pengguna mengakses aplikasi dari berbagai perangkat dengan ukuran layar yang berbeda, mulai dari ponsel, tablet, hingga desktop. Agar pengalaman pengguna tetap optimal di semua perangkat tersebut, responsive design memungkinkan tata letak dan elemen di halaman web menyesuaikan ukuran, tampilan, dan fungsionalitas berdasarkan perangkat yang digunakan. Aplikasi yang sudah menerapkan responsive design antara lain, Facebook, Twitter(X), Instagram, Tokopedia, Shopee, dan berbagai aplikasi baru lainnya. Aplikasi web yang belum menerapkan responsive design adalah situs-situs web lama seperti blog.

Jawaban nomor 3:
Margin mengatur ruang yang ada di luar elemen, Border mengatur garis pembatas elemen, Padding mengatur ruang antara konten elemen dengan border

Jawaban nomor 4:
Flexbox adalah sistem layout satu dimensi yang mengatur elemen secara horizontal atau vertikal. Kegunaan dari flebox adalah untuk membuat tata letak yang fleksibel dan responsif untuk elemen yang sejajar dalam satu dimensi, menyederhanakan pembuatan layout seperti centered content, alignment, spacing, dan wrapping elemen anak. Grid layout adalahsistem layout dua dimensi, yang mengatur elemen secara baris dan klom, pada gird dapat membuat berbagai baris dan berbagai kolom.  Kegunaan dari grid layout adalah untuk mengontrol tata letak elemen pada sumbu baris dan kolom dengam mudah.
